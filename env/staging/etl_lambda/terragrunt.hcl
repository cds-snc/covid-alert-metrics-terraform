...
inputs = { 
  ...
  unmasked_metrics_bucket = dependency.s3.outputs.unmasked_metrics_bucket
  unmasked_metrics_s3_arn = dependency.s3.outputs.unmasked_metrics_buckets_arn
  masked_metrics_s3_arn = dependency.s3.outputs.masked_metrics_buckets_arn
}
